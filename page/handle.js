...
window.onload = function() {
  var converter, req, req2, req3, req4;
  ...
  document.body.insertAdjacentHTML("beforeend", lilyturf.html(function() {
    return this.div({
      ...
      "class": "bold"
    }, this.text("This is generated in HTML way")), this.p({}, this.text("This is my way generating HTML in the runtime of CoffeeScript.")), this.p({}, this.text("JavaScript is a language born to deal with HTML, and it should be.")), this.p({}, this.text("So, just integrate HTML's syntax into CoffeeScript.")));
  }));
  ...
  req.onload = function(res) {
    ...
    block = lilyturf.html(function() {
      return this.div({}, this.div({
        "class": "intro"
      }, this.text("This is all my code for implementing Lilyturf:")), this.pre({
        id: "source"
      }, this.code({
        "class": "coffeescript"
  ...
  req4.onload = function(res) {
    ...
    block = lilyturf.dom(function() {
      return this.div({}, this.div({
        ...
        id: "readme"
      }, this.html(converter.makeHtml(res.target.response))));
    });
    return (q("#code")).appendChild(block);
  };
